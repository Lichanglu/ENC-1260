...
int mult_rtp_get_active(void);
int mult_ts_get_active(void);
int mult_rtpts_get_active(void);
int mult_get_direct_rtp_mtu(void);
int mult_get_direct_ts_mtu(void);
int mult_get_rtp_ts_mtu(void);
